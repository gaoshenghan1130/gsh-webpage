...
export default function LeftFilter({ skillCategories, selectedSkills, onChange }: LeftFilterProps) {
  ...
  return (
    <div className="fixed top-[25.0%] left-0 flex h-[20.0%] w-1/4 flex-col overflow-y-auto rounded-r-3xl border border-gray-200/50 bg-white/60 px-6 py-4 shadow-md backdrop-blur-2xl transition-all duration-300">
